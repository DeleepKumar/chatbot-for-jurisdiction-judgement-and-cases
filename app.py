...
llm=ChatGroq(groq_api_key='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',
             model_name="llama3-70b-8192")
prompt=ChatPromptTemplate.from_template(
"""
Answer the questions based on the provided context and also the imformation present in the llm about mining .
...
st.title("JURISDICTION JUDGEMENT AND CASES")
with st.spinner("Loading pdf"):
    pdf_loader = PyPDFLoader("12405_2018_Judgement_06-Jul-2018.pdf")
